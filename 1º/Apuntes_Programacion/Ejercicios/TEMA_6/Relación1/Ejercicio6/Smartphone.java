...
public class Smartphone implements DispositivoInteligente {
    ...
    public String encender() {
        ...
        if (isEstado()) {
            mostrarMensaje = "Ya esta encendida el movil";
        } else {
            mostrarMensaje = "Acabas de encender el movil";
            setEstado(true);
        }
    ...
    public String apagar() {
        ...
        if (!isEstado()) {
            mostrarMensaje = "Ya esta apagado el movil";
        } else {
            mostrarMensaje = "Acabas de apagar el movil";
            setEstado(false);
        }
        return mostrarMensaje;
    }
    ...
    public String conectarWiFi() {
        ...
        if (isEstadoWifi()) {
            mostrarMensaje = "Ya esta conectado al wifi tu movil";
        } else {
